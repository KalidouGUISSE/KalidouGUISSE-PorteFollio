      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {data.skills.map((skill, index) => (
            <div
              key={skill.id}
              className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-2 animate-fade-in-up border border-gray-100 dark:border-gray-700"
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm animate-fade-in-up animation-delay-600 border border-gray-100 dark:border-gray-700">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {data.languages.map((lang, index) => (
              <div
                key={lang.id}
                className="text-center p-6 bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/20 dark:to-gray-700/50 rounded-xl transition-all duration-300 hover:scale-105 border border-blue-100 dark:border-blue-800/30"
                style={{ animationDelay: `${index * 100}ms` }}
              >
